		...
		_createClass(Search, null, [{
			...
			get: function get() {
				return {
					...
					objectRespone: _react2.default.PropTypes.string,
				...
				if (props.callBackBackEnd !== undefined && props.objectRespone !== undefined && inputSearch !== '') {
					...
					props.callBackBackEnd(inputSearch).then(function (response) {
						...
						if (response.data[props.objectRespone] !== undefined) {
							_this2._setStateSearch(response.data[props.objectRespone], inputSearch);
						}
					});
			...
			value: function render() {
						...
						// render the value search when input search not null
							...
							return _react2.default.createElement(
								...
								state.dataSearch.map(function (item, index) {
									...
									return _react2.default.createElement('li', { onClick: _this3._onClickSelect.bind(_this3, index), onMouseOver: _this3._onMouseOverSelect.bind(_this3, index), className: state.indexSelect === index ? 'search-item search-item-active' : 'search-item', key: index, dangerouslySetInnerHTML: { __html: itemTestBold } });
								})
							);
						}
				};
				...
				var clearReander = function clearReander() {
					if (state.inputSearch !== '') {
						return _react2.default.createElement('button', { className: 'search-clear', onClick: _this3._onClear });
					}
				};
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement('input', { onChange: this._onChangeSearch,
