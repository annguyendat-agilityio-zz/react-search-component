...
/***/ function(module, exports, __webpack_require__) {
	...
	var Carousel = function (_React$Component) {
		...
		function Carousel(props) {
			...
			_this._slidePrevNext = _this._slidePrevNext.bind(_this);
			_this._setInterval = _this._setInterval.bind(_this);
			_this._addTransition = _this._addTransition.bind(_this);
			return _this;
		}
		...
		_createClass(Carousel, [{
			...
			value: function componentDidMount() {
				...
				var intervalId = this._setInterval();
			...
			value: function _dotActive(i) {
				...
				var delay = _state3.delay;
				var intervalId = _state3.intervalId;


				clearInterval(intervalId);

				var interval = this._setInterval();
			...
			value: function _addTransition() {
				...
				var transitionMs = this.state.transitionMs;
			...
			value: function render() {
				...
				var transitionMs = _state5.transitionMs;


				var renderSlide = children.map(function (item, i) {
					return _react2.default.createElement(
						'div',
						{
							key: i,
				...
				var renderDot = function renderDot() {
					return _react2.default.createElement(
						...
						children.map(function (item, i) {
							return _react2.default.createElement('li', { key: i, className: 'dot-slide ' + (index === i ? 'active' : ''), onClick: _this3._dotActive.bind(_this3, i) });
						})
					);
				};
				...
				var renderPrevNext = function renderPrevNext() {
					return _react2.default.createElement(
						'div',
						null,
						_react2.default.createElement('a', { className: 'slide-prev', onClick: _this3._slidePrevNext.bind(_this3, 'prev') }),
						_react2.default.createElement('a', { className: 'slide-next', onClick: _this3._slidePrevNext.bind(_this3, 'next') })
					);
				};
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'carousel-content', style: widthTransform },
						renderSlide
					),
					renderDot()
				);
