...
/***/ function(module, exports, __webpack_require__) {
	...
	var Modal = function (_React$Component) {
		...
		function Modal(props) {
			...
			_this.state = {
				showModal: _this.props.showModal !== undefined ? _this.props.showModal : false,
				// Element close icon default if undefined
				closeIcon: _this.props.closeIcon !== undefined ? _this.props.closeIcon : _react2.default.createElement('span', { className: 'modal-close', onClick: _this._closeModal.bind(_this) })
			};
		...
		_createClass(Modal, [{
			...
			value: function render() {
				...
				var className = showModal ? 'modal show' : 'modal';

				return _react2.default.createElement(
					'div',
					{ className: className },
					_react2.default.createElement('div', { className: 'modal-overlay', onClick: this._closeModal }),
			...
			get: function get() {
				return {
					...
					closeIcon: _react2.default.PropTypes.element
				};
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Search = function (_React$Component) {
		...
		_createClass(Search, null, [{
			...
			get: function get() {
				return {
					...
					keySearch: _react2.default.PropTypes.string,
					objectResponse: _react2.default.PropTypes.string,
					callBackBackEnd: _react2.default.PropTypes.func,
					getValueSearch: _react2.default.PropTypes.func
				};
			}
		}]);
		...
		function Search(props) {
			...
			_this._onKeyDownSelect = _this._onKeyDownSelect.bind(_this);
			_this._onClickSelect = _this._onClickSelect.bind(_this);
			_this._onClear = _this._onClear.bind(_this);
			_this._handleSearch = _this._handleSearch.bind(_this);
			_this._setStateSearch = _this._setStateSearch.bind(_this);
			return _this;
		}
		...
		_createClass(Search, [{
			key: '_setStateSearch',
			value: function _setStateSearch(response, inputSearch) {
			...
			key: '_onChangeSearch',
			value: function _onChangeSearch(evt) {
				var _this2 = this;

				var state = this.state,
				    props = this.props;

				var inputSearch = evt.target.value,
				    dataSearch = void 0;
				...
				if (props.callBackBackEnd !== undefined && props.objectResponse !== undefined && inputSearch !== '') {
					...
					props.callBackBackEnd(inputSearch).then(function (response) {

						if (response.data[props.objectResponse] !== undefined) {

							_this2._setStateSearch(response.data[props.objectResponse], inputSearch);
						}
					});
					...
					// Handle search from data user
						...
						props.data.map(function (item, index) {
							...
							var inputSearchRegExp = new RegExp(inputSearch, 'gi');

							var itemSearch = item[props.keySearch];
			...
			key: '_onKeyDownSelect',
			value: function _onKeyDownSelect(evt) {
				...
				if (evt.keyCode === 38 && state.indexSelect > 0) {
					...
					// when user use arrow down select value search
						...
						// when user select value search and enter
							...
							var valSearch = state.dataSearch && state.dataSearch.length > 0 ? state.dataSearch[state.indexSelect] : state.inputSearch;
			...
			key: '_onClickSelect',
			value: function _onClickSelect(index) {
			...
			key: '_onMouseOverSelect',
			value: function _onMouseOverSelect(index) {
				this.setState({
					indexSelect: index
				});
			}
			...
			value: function render() {
				...
				var renderDataSearch = function renderDataSearch() {
					...
					if (state.isLoading) {
						return _react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement('div', { className: 'loading-border loading-right' }),
								_react2.default.createElement('div', { className: 'loading-border loading-left' }),
								_react2.default.createElement('div', { className: 'loading-border loading-mid' })
							)
						);
						// render the value search when input search not null
							...
							return _react2.default.createElement(
								'ul',
								null,
								state.dataSearch.map(function (item, index) {

									// Create regular expression for input search
									var inputSearchRegExp = new RegExp(state.inputSearch, 'gi');

									// Bold value search
									var itemTestBold = item.replace(inputSearchRegExp, "<strong>$&</strong>");

									return _react2.default.createElement('li', {
										onClick: _this3._onClickSelect.bind(_this3, index),
										onMouseOver: _this3._onMouseOverSelect.bind(_this3, index),
				...
				var clearReander = function clearReander() {
					if (state.inputSearch !== '') {
						return _react2.default.createElement('button', {
							className: 'search-clear',
							onClick: _this3._onClear });
					}
				};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Carousel = function (_React$Component) {
		...
		_createClass(Carousel, null, [{
			...
			get: function get() {
				return {
					delayAutoPlay: _react2.default.PropTypes.number,
					timeTransition: _react2.default.PropTypes.number,
					arrowPrevNext: _react2.default.PropTypes.bool,
					dotSlide: _react2.default.PropTypes.bool,
		...
		function Carousel(props) {
			...
			_this.state = {
				...
				arrowPrevNext: _this.props.arrowPrevNext !== undefined ? _this.props.arrowPrevNext : true,
				dotSlide: _this.props.dotSlide !== undefined ? _this.props.dotSlide : true,
				delayAutoPlay: _this.props.delayAutoPlay !== undefined ? _this.props.delayAutoPlay : 3000,
				timeTransition: _this.props.timeTransition !== undefined ? _this.props.timeTransition : 500,
				transition: false
			};

			_this._autoPlay = _this._autoPlay.bind(_this);
			_this._setInterval = _this._setInterval.bind(_this);
			_this._resetIndex = _this._resetIndex.bind(_this);
			return _this;
		}
		...
		_createClass(Carousel, [{
			...
			value: function _setInterval() {
				...
				var delayAutoPlay = _state.delayAutoPlay;
			...
			value: function _autoPlay() {
				...
				var childrenCount = _state2.childrenCount;
				var children = this.props.children;
			...
			key: '_slidePrevNext',
			value: function _slidePrevNext(type) {
				var _state3 = this.state;
				var index = _state3.index;
				var childrenCount = _state3.childrenCount;
				var intervalId = _state3.intervalId;
			...
			key: '_resetIndex',
			value: function _resetIndex(index) {
				var _this2 = this;

				var _state4 = this.state;
				var timeTransition = _state4.timeTransition;
				var childrenCount = _state4.childrenCount;
			...
			value: function render() {
				...
				var widthBase = _state5.widthBase;
				var childrenCount = _state5.childrenCount;
				var index = _state5.index;
				var transition = _state5.transition;
				var timeTransition = _state5.timeTransition;
				var dotSlide = _state5.dotSlide;
				var arrowPrevNext = _state5.arrowPrevNext;
				...
				var renderSlide = function renderSlide() {
					...
					for (var i = -1, _len = childrenCount; i < _len + 1; i++) {
					...
					if (dotSlide) {
						return _react2.default.createElement(
							...
							children.map(function (item, i) {
								...
								var dotStyle = index === i ? 'dot-slide active' : 'dot-slide';

								return _react2.default.createElement('li', {
									key: i,
									className: dotStyle,
									onClick: _this3._dotActive.bind(_this3, i)
								});
							})
						);
					}
				...
				var renderPrevNext = function renderPrevNext() {
					...
					if (arrowPrevNext) {
						return _react2.default.createElement(
							...
							_react2.default.createElement('a', {
								...
								onClick: _this3._slidePrevNext.bind(_this3, 'prev')
							}),
							_react2.default.createElement('a', {
								className: 'slide-next',
								onClick: _this3._slidePrevNext.bind(_this3, 'next')
							})
						);
					}
				};
